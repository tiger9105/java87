   ...
   //////////////////
     ...
     //////////////////
		...
		//$('iframe').each(function(i, e) {
			/* var returnValue = */
			/*  alert(returnValue); */
		//	var abc = new Array(("iframe").length);

		//	abc.push($("iframe")[i].src);
		//	alert(abc);
			/*   $.cookie('uri', returnValue);
			  $.cookie('uri', 'ok', { expires: 7, path: 'test3.jsp', domain: 'test4.jsp', secure: false });
			 *///uri 뽑았다 치는데 key 값을 어떻게 핡것인가 그냥 URI ?????
		//});
	</script>
</body>
</html>
